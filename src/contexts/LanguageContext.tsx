...
export const translations: Translations = {
  ...
  // Store Settings
  "pricing.per_match": { fr: "Par Match", en: "Per Match", ar: "للمباراة" },
  "pricing.per_hour": { fr: "Par Heure", en: "Per Hour", ar: "للساعة" },
  ...
  "services.management.phone_label": { fr: "Téléphone", en: "Phone", ar: "الهاتف" },
  "services.management.device_type": { fr: "Type d'Appareil", en: "Device Type", ar: "نوع الجهاز" },
  "services.management.device_brand": { fr: "Marque", en: "Brand", ar: "العلامة التجارية" },
  "services.management.device_model": { fr: "Modèle", en: "Model", ar: "الطراز" },
  "services.management.priority": { fr: "Priorité", en: "Priority", ar: "الأولوية" },
  "services.management.priority_low": { fr: "Faible", en: "Low", ar: "منخفضة" },
  "services.management.priority_normal": { fr: "Normale", en: "Normal", ar: "عادية" },
  "services.management.priority_high": { fr: "Haute", en: "High", ar: "عالية" },
  "services.management.priority_urgent": { fr: "Urgente", en: "Urgent", ar: "طارئة" },
  "services.management.issue_label": { fr: "Description du Problème *", en: "Issue Description *", ar: "وصف المشكلة *" },
  "services.management.client_name": { fr: "Nom du Client *", en: "Client Name *", ar: "اسم العميل *" },
  "services.management.est_cost": { fr: "Coût Estimé (DT)", en: "Est. Cost (DT)", ar: "التكلفة التقديرية (د.ت)" },
  "services.management.service_label": { fr: "Service *", en: "Service *", ar: "الخدمة *" },
  "services.management.select_service": { fr: "Sélectionner un service", en: "Select service", ar: "اختر الخدمة" },
  "services.management.custom_service": { fr: "+ Service Personnalisé", en: "+ Custom Service", ar: "+ خدمة مخصصة" },
  "services.management.quick_add": { fr: "⚡ Ajout Rapide Service Personnalisé", en: "⚡ Quick Add Custom Service", ar: "⚡ إضافة خدمة مخصصة" },
  "services.management.complex_requires_owner": { fr: "Nécessite vérification du propriétaire", en: "Requires owner verification to finish", ar: "يتطلب تحقق المالك للإتمام" },
  "services.management.service_name_en": { fr: "Nom (EN)", en: "Name (EN)", ar: "الاسم (إنجليزي)" },
  "services.management.service_name_fr": { fr: "Nom (FR)", en: "Name (FR)", ar: "الاسم (فرنسي)" },
  "services.management.base_price": { fr: "Prix de Base (DT)", en: "Base Price (DT)", ar: "السعر الأساسي (د.ت)" },
  "services.management.category": { fr: "Catégorie", en: "Category", ar: "الفئة" },
  "services.management.image_url": { fr: "URL Image (Optionnel)", en: "Image URL (Optional)", ar: "رابط الصورة (اختياري)" },
  "services.cat.phone": { fr: "Réparation Téléphone", en: "Phone Repair", ar: "إصلاح الهاتف" },
  "services.cat.console": { fr: "Réparation Console", en: "Console Repair", ar: "إصلاح جهاز الألعاب" },
  "services.cat.controller": { fr: "Réparation Manette", en: "Controller Repair", ar: "إصلاح المتحكم" },
  "services.cat.pc": { fr: "Réparation PC", en: "PC Repair", ar: "إصلاح الكمبيوتر" },
  "services.cat.accounts": { fr: "Comptes", en: "Accounts", ar: "الحسابات" },
  "services.cat.sales": { fr: "Ventes", en: "Sales", ar: "المبيعات" },

  // Transactions History
  "transactions.title": { fr: "Historique des Transactions", en: "Transactions History", ar: "سجل المعاملات" },
  "transactions.subtitle": { fr: "Consulter les ventes et sessions gaming terminées.", en: "Review sales and completed gaming sessions.", ar: "مراجعة المبيعات وجلسات الألعاب المنجزة." },
  "transactions.all": { fr: "Toutes les Transactions", en: "All Transactions", ar: "جميع المعاملات" },
  "transactions.recent_records": { fr: "enregistrements récents", en: "recent records", ar: "سجلات حديثة" },
  "transactions.col_date": { fr: "Date", en: "Date", ar: "التاريخ" },
  "transactions.col_type": { fr: "Type", en: "Type", ar: "النوع" },
  "transactions.col_description": { fr: "Description", en: "Description", ar: "الوصف" },
  "transactions.col_client": { fr: "Client", en: "Client", ar: "العميل" },
  "transactions.col_staff": { fr: "Personnel", en: "Staff", ar: "الموظف" },
  "transactions.col_amount": { fr: "Montant", en: "Amount", ar: "المبلغ" },
  "transactions.col_actions": { fr: "Actions", en: "Actions", ar: "الإجراءات" },
  "transactions.type_sale": { fr: "Vente", en: "Sale", ar: "بيع" },
  "transactions.type_session": { fr: "Session", en: "Session", ar: "جلسة" },
  "transactions.empty": { fr: "Aucune transaction trouvée.", en: "No transactions found.", ar: "لم توجد معاملات." },
  "transactions.page_of": { fr: "Page {page} sur {total}", en: "Page {page} of {total}", ar: "صفحة {page} من {total}" },
  "transactions.prev": { fr: "Précédent", en: "Previous", ar: "السابق" },
  "transactions.next": { fr: "Suivant", en: "Next", ar: "التالي" },
  "transactions.delete_title": { fr: "Supprimer la Transaction ?", en: "Delete Transaction?", ar: "حذف المعاملة؟" },
  "transactions.delete_desc": { fr: "Cette action est irréversible. L'enregistrement sera supprimé définitivement.", en: "This action cannot be undone. This will permanently remove the record from the database.", ar: "هذا الإجراء لا يمكن التراجع عنه. سيُحذف السجل نهائياً من قاعدة البيانات." },
  "transactions.delete_confirm": { fr: "Supprimer", en: "Delete", ar: "حذف" },
  "transactions.gaming_session": { fr: "Session Gaming", en: "Gaming Session", ar: "جلسة ألعاب" },
  "transactions.unknown_product": { fr: "Produit Inconnu", en: "Unknown Product", ar: "منتج غير معروف" },
  "transactions.walk_in": { fr: "Client Passage", en: "Walk-in", ar: "زبون عابر" },
  "transactions.unknown_staff": { fr: "Inconnu", en: "Unknown", ar: "غير معروف" },
  "transactions.help": { fr: "Historique des ventes et sessions. Les 200 enregistrements les plus récents.", en: "Merged history of product sales and gaming sessions. Most recent 200 items.", ar: "سجل موحد للمبيعات وجلسات الألعاب. آخر 200 عنصر." },
  "transactions.access_denied": { fr: "Accès Refusé. Propriétaire uniquement.", en: "Access Denied. Owner only.", ar: "الوصول مرفوض. المالك فقط." },

  // Sales Dialog
  "sales.payment_summary": { fr: "Résumé du Paiement", en: "Payment Summary", ar: "ملخص الدفع" },
  "sales.subtotal": { fr: "Sous-total :", en: "Subtotal:", ar: "المجموع الفرعي:" },
  "sales.points_discount": { fr: "Remise points :", en: "Points discount:", ar: "خصم النقاط:" },
  "sales.total_pay": { fr: "Total à payer :", en: "Total to pay:", ar: "المبلغ الإجمالي:" },
  "sales.points_used_label": { fr: "Points utilisés :", en: "Points used:", ar: "النقاط المستخدمة:" },
  "sales.points_to_use": { fr: "Points à Utiliser", en: "Points to Use", ar: "النقاط المستخدمة" },
  "sales.points_deduct": { fr: "Points à déduire :", en: "Points to deduct:", ar: "النقاط المخصومة:" },
  "sales.cash_payment": { fr: "Paiement en espèces :", en: "Cash payment:", ar: "الدفع نقداً:" },
  "sales.client_balance_after": { fr: "Solde client après :", en: "Client balance after:", ar: "رصيد العميل بعد:" },
  "sales.staff_confirm": { fr: "Le personnel confirme la légitimité de la transaction par points", en: "Staff confirms points transaction is legitimate", ar: "الموظف يؤكد شرعية معاملة النقاط" },
  "sales.client_confirms": { fr: "Le client confirme et autorise l'utilisation des points", en: "Client confirms and authorizes points usage", ar: "العميل يؤكد ويفوض استخدام النقاط" },
  "sales.confirm_complete": { fr: "Confirmer & Finaliser la Vente", en: "Confirm & Complete Sale", ar: "تأكيد وإتمام البيع" },
  "sales.available_points": { fr: "Disponible : {points} points (1 DT = 1000 points)", en: "Available: {points} points (1 DT = 1000 points)", ar: "المتاح: {points} نقطة (1 د.ت = 1000 نقطة)" },
  "sales.phone_placeholder": { fr: "Numéro de Téléphone", en: "Phone Number", ar: "رقم الهاتف" },

  // Products Minor Labels
...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  ...
  const value = useMemo(() => ({ language, setLanguage, t, dir }), [language, dir]);
